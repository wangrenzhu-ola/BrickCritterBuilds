    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            ZStack(alignment: .bottom) {
                ...
                CritterBuildGlass(stage: .tinyDragon, cue: cue).padding(.horizontal, 18).padding(.bottom, 14)
            }
            .frame(height: 220)
        }
        .padding()
...
struct CritterBuildGlass: View {
    let stage: CritterStyle
    let cue: BuildCue
...
struct CritterBuildCard: View {
    ...
    var body: some View {
        ...
        .padding()
        .background(Color(hex: record.buildCueHex).opacity(0.12), in: RoundedRectangle(cornerRadius: 22))
    }
}
...
struct SuccessToast: View {
    ...
    var body: some View {
        ...
        .accessibilityElement(children: .combine)
        .accessibilityLabel("Critter Build saved.")
    }
}
